...
public class CustomToast_Text0 {
	...
	private CustomToast_Text0(Context context, String text) {
...
//		}
		...
		//messageTextView.setAnimation(shakeAnimation(5));
	...
	public static CustomToast_Text0 makeText(Context context, String text) {
		CustomToast_Text0 toastCustom = new CustomToast_Text0(context, text);
		return toastCustom;
	}
