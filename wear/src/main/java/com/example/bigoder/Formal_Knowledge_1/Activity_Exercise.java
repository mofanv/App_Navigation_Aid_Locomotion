 ...
 */
public class Activity_Exercise extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_exercise_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "锻炼总览");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "坐");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "站立");
        }else if(viewsCurrent == 4){
            new CustomToast_Text(mContext, "活动");
        }else if(viewsCurrent == 5){
            new CustomToast_Text(mContext, "健身");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_exercise_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_exercise_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_exercise_3, null);
        View view4 = LayoutInflater.from(this).inflate(R.layout.acti_exercise_4, null);
        View view5 = LayoutInflater.from(this).inflate(R.layout.acti_exercise_5, null);
        View view6 = LayoutInflater.from(this).inflate(R.layout.acti_exercise_6, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Exercise());
        ...
        MYViewPagerAdapter_Exercise adapter = new MYViewPagerAdapter_Exercise();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);

        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.exercise_dot);
...
class MYViewPagerAdapter_Exercise extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Exercise ma = new Activity_Exercise();
...
class CustmerAnimation_Exercise implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Exercise ma = new Activity_Exercise();
        viewsCount = MYViewPagerAdapter_Exercise.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Exercise.viewsCurrentItem + 1;

        if(Activity_Exercise.firstCircleNum != viewsCurrent){
            Activity_Exercise.firstCircleNum = viewsCurrent;
