 ...
 */
public class Activity_Compass extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_compass_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "指南针");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_compass_1, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Compass());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);

        MYViewPagerAdapter_Compass adapter = new MYViewPagerAdapter_Compass();
...
class MYViewPagerAdapter_Compass extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Compass ma = new Activity_Compass();
...
class CustmerAnimation_Compass implements ViewPager.PageTransformer {
