 ...
 */
public class Activity_Wechat extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_wechat_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "未读消息");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "最近联系人");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "朋友圈");
        }else if(viewsCurrent == 4){
            new CustomToast_Text(mContext, "语音搜索");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_wechat_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_wechat_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_wechat_3, null);
        View view4 = LayoutInflater.from(this).inflate(R.layout.acti_wechat_4, null);
        View view5 = LayoutInflater.from(this).inflate(R.layout.acti_wechat_5, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Wechat());
        ...
        MYViewPagerAdapter_Wechat adapter = new MYViewPagerAdapter_Wechat();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.wechat_dot);
...
class MYViewPagerAdapter_Wechat extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Wechat ma = new Activity_Wechat();
...
class CustmerAnimation_Wechat implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Wechat ma = new Activity_Wechat();
        viewsCount = MYViewPagerAdapter_Wechat.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Wechat.viewsCurrentItem + 1;

        if(Activity_Wechat.firstCircleNum != viewsCurrent){
            Activity_Wechat.firstCircleNum = viewsCurrent;
