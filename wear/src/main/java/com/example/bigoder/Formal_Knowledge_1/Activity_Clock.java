 ...
 */
public class Activity_Clock extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_clock_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "时钟");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_clock_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_clock_2, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Clock());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);
        views.add(view2);

        MYViewPagerAdapter_Clock adapter = new MYViewPagerAdapter_Clock();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.clock_dot);
...
class MYViewPagerAdapter_Clock extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Clock ma = new Activity_Clock();
...
class CustmerAnimation_Clock implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Clock ma = new Activity_Clock();
        viewsCount = MYViewPagerAdapter_Clock.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Clock.viewsCurrentItem + 1;

        if(Activity_Clock.firstCircleNum != viewsCurrent){
            Activity_Clock.firstCircleNum = viewsCurrent;
