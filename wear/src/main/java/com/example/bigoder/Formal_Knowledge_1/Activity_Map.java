 ...
 */
public class Activity_Map extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_map_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "地图");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_map_1, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Map());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);

        MYViewPagerAdapter_Map adapter = new MYViewPagerAdapter_Map();
...
class MYViewPagerAdapter_Map extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Map ma = new Activity_Map();
...
class CustmerAnimation_Map implements ViewPager.PageTransformer {
