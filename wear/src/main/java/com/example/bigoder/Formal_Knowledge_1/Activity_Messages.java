 ...
 */
public class Activity_Messages extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_messages_main);
        initViewPager();
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_messages_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_messages_2, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Messages());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);
        views.add(view2);

        MYViewPagerAdapter_Messages adapter = new MYViewPagerAdapter_Messages();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.messages_dot);
...
class MYViewPagerAdapter_Messages extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Messages ma = new Activity_Messages();
...
class CustmerAnimation_Messages implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Messages ma = new Activity_Messages();
        viewsCount = MYViewPagerAdapter_Messages.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Messages.viewsCurrentItem + 1;

        if(Activity_Messages.firstCircleNum != viewsCurrent){
            Activity_Messages.firstCircleNum = viewsCurrent;
