 ...
 */
public class Activity_Sleep extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_sleep_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "睡眠情况");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "总体评价");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "改善意见");
        }
    }
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_sleep_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_sleep_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_sleep_3, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Sleep());
        ...
        MYViewPagerAdapter_Sleep adapter = new MYViewPagerAdapter_Sleep();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.sleep_dot);
...
class MYViewPagerAdapter_Sleep extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Sleep ma = new Activity_Sleep();
...
class CustmerAnimation_Sleep implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Sleep ma = new Activity_Sleep();
        viewsCount = MYViewPagerAdapter_Sleep.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Sleep.viewsCurrentItem + 1;

        if(Activity_Sleep.firstCircleNum != viewsCurrent){
            Activity_Sleep.firstCircleNum = viewsCurrent;
