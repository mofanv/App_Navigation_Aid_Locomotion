 ...
 */
public class Activity_Browser extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_browser_main);
        initViewPager();
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "收藏夹");
        }
    }
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_browser_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_browser_2, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Browser());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);
        views.add(view2);

        MYViewPagerAdapter_Browser adapter = new MYViewPagerAdapter_Browser();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);

        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.browser_dot);
...
class MYViewPagerAdapter_Browser extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Browser ma = new Activity_Browser();
...
class CustmerAnimation_Browser implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Browser ma = new Activity_Browser();
        viewsCount = MYViewPagerAdapter_Browser.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Browser.viewsCurrentItem + 1;

        if(Activity_Browser.firstCircleNum != viewsCurrent){
            Activity_Browser.firstCircleNum = viewsCurrent;
