 ...
 */
public class Activity_Phone extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_phone_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "来电");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "拨号");
        }
    }
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_phone_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_phone_2, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Phone());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);
        views.add(view2);

        MYViewPagerAdapter_Phone adapter = new MYViewPagerAdapter_Phone();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.phone_dot);
...
class MYViewPagerAdapter_Phone extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Phone ma = new Activity_Phone();
...
class CustmerAnimation_Phone implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Phone ma = new Activity_Phone();
        viewsCount = MYViewPagerAdapter_Phone.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Phone.viewsCurrentItem + 1;

        if(Activity_Phone.firstCircleNum != viewsCurrent){
            Activity_Phone.firstCircleNum = viewsCurrent;
