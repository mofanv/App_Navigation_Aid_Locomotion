 ...
 */
public class Activity_Camera extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_camera_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "相机");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_camera_1, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Camera());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);

        MYViewPagerAdapter_Camera adapter = new MYViewPagerAdapter_Camera();
...
class MYViewPagerAdapter_Camera extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Camera ma = new Activity_Camera();
...
class CustmerAnimation_Camera implements ViewPager.PageTransformer {
