 ...
 */
public class Activity_Weather extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_weather_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "天气概况");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "重庆");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "北京");
        } else if(viewsCurrent == 4){
            new CustomToast_Text(mContext, "成都");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_weather_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_weather_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_weather_3, null);
        View view4 = LayoutInflater.from(this).inflate(R.layout.acti_weather_4, null);
        View view5 = LayoutInflater.from(this).inflate(R.layout.acti_weather_5, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Weather());
        ...
        MYViewPagerAdapter_Weather adapter = new MYViewPagerAdapter_Weather();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.weather_dot);
...
class MYViewPagerAdapter_Weather extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Weather ma = new Activity_Weather();
...
class CustmerAnimation_Weather implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Weather ma = new Activity_Weather();
        viewsCount = MYViewPagerAdapter_Weather.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Weather.viewsCurrentItem + 1;

        if(Activity_Weather.firstCircleNum != viewsCurrent){
            Activity_Weather.firstCircleNum = viewsCurrent;
