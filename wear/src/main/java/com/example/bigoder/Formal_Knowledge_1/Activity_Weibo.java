 ...
 */
public class Activity_Weibo extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_weibo_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "微博订阅");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "主页");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "消息");
        }
    }
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_weibo_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_weibo_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_weibo_3, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Weibo());
        ...
        MYViewPagerAdapter_Weibo adapter = new MYViewPagerAdapter_Weibo();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.weibo_dot);
...
class MYViewPagerAdapter_Weibo extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Weibo ma = new Activity_Weibo();
...
class CustmerAnimation_Weibo implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Weibo ma = new Activity_Weibo();
        viewsCount = MYViewPagerAdapter_Weibo.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Weibo.viewsCurrentItem + 1;

        if(Activity_Weibo.firstCircleNum != viewsCurrent){
            Activity_Weibo.firstCircleNum = viewsCurrent;
...
//        int viewsCurrent;
//
//        MYViewPagerAdapter_Weibo mvpa = new MYViewPagerAdapter_Weibo();
