 ...
 */
public class Activity_Downloads extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_downloads_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "全部下载");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "未完成");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "已完成");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_downloads_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_downloads_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_downloads_3, null);
        View view4 = LayoutInflater.from(this).inflate(R.layout.acti_downloads_4, null);


        viewPager.setPageTransformer(true, new CustmerAnimation_Downloads());
        ...
        MYViewPagerAdapter_Downloads adapter = new MYViewPagerAdapter_Downloads();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.downloads_dot);
...
class MYViewPagerAdapter_Downloads extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Downloads ma = new Activity_Downloads();
...
class CustmerAnimation_Downloads implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Downloads ma = new Activity_Downloads();
        viewsCount = MYViewPagerAdapter_Downloads.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Downloads.viewsCurrentItem + 1;

        if(Activity_Downloads.firstCircleNum != viewsCurrent){
            Activity_Downloads.firstCircleNum = viewsCurrent;
