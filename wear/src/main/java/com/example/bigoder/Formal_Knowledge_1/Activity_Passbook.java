 ...
 */
public class Activity_Passbook extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_passbook_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "优惠券");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "登机牌");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "会员卡");
        }else if(viewsCurrent == 4){
            new CustomToast_Text(mContext, "门票车票");
        }
    }
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_passbook_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_passbook_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_passbook_3, null);
        View view4 = LayoutInflater.from(this).inflate(R.layout.acti_passbook_4, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Passbook());
        ...
        MYViewPagerAdapter_Passbook adapter = new MYViewPagerAdapter_Passbook();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.passbook_dot);
...
class MYViewPagerAdapter_Passbook extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Passbook ma = new Activity_Passbook();
...
class CustmerAnimation_Passbook implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Passbook ma = new Activity_Passbook();
        viewsCount = MYViewPagerAdapter_Passbook.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Passbook.viewsCurrentItem + 1;

        if(Activity_Passbook.firstCircleNum != viewsCurrent){
            Activity_Passbook.firstCircleNum = viewsCurrent;
