 ...
 */
public class Activity_Calendar extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_calendar_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "日历");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_calendar_1, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Calendar());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);

        MYViewPagerAdapter_Calendar adapter = new MYViewPagerAdapter_Calendar();
...
class MYViewPagerAdapter_Calendar extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Calendar ma = new Activity_Calendar();
...
class CustmerAnimation_Calendar implements ViewPager.PageTransformer {
