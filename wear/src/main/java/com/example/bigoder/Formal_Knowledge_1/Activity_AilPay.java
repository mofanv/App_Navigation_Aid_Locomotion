 ...
 */
public class Activity_AilPay extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_ailpay_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "支付卡");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_ailpay_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_ailpay_2, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_AilPay());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);
        views.add(view2);

        MYViewPagerAdapter_AilPay adapter = new MYViewPagerAdapter_AilPay();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);

        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.ailpay_dot);
...
class MYViewPagerAdapter_AilPay extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_AilPay ma = new Activity_AilPay();
...
class CustmerAnimation_AilPay implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_AilPay ma = new Activity_AilPay();
        viewsCount = MYViewPagerAdapter_AilPay.viewsCount;
        viewsCurrent = MYViewPagerAdapter_AilPay.viewsCurrentItem + 1;

        if(Activity_AilPay.firstCircleNum != viewsCurrent){
            Activity_AilPay.firstCircleNum = viewsCurrent;
