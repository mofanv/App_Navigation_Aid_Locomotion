 ...
 */
public class Activity_QQ extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_qq_main);
        initViewPager();
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_qq_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_qq_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_qq_3, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_QQ());
        ...
        MYViewPagerAdapter_QQ adapter = new MYViewPagerAdapter_QQ();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.qq_dot);
...
class MYViewPagerAdapter_QQ extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_QQ ma = new Activity_QQ();
...
class CustmerAnimation_QQ implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_QQ ma = new Activity_QQ();
        viewsCount = MYViewPagerAdapter_QQ.viewsCount;
        viewsCurrent = MYViewPagerAdapter_QQ.viewsCurrentItem + 1;

        if(Activity_QQ.firstCircleNum != viewsCurrent){
            Activity_QQ.firstCircleNum = viewsCurrent;
