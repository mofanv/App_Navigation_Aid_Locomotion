 ...
 */
public class Activity_Contacts extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_contacts_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "联系人 1");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "联系人 2");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "联系人 3");
        }else if(viewsCurrent == 4){
            new CustomToast_Text(mContext, "其他联系人");
        }
    }
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_contacts_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_contacts_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_contacts_3, null);
        View view4 = LayoutInflater.from(this).inflate(R.layout.acti_contacts_4, null);


        viewPager.setPageTransformer(true, new CustmerAnimation_Contacts());
        ...
        MYViewPagerAdapter_Contacts adapter = new MYViewPagerAdapter_Contacts();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.contacts_dot);
...
class MYViewPagerAdapter_Contacts extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Contacts ma = new Activity_Contacts();
...
class CustmerAnimation_Contacts implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Contacts ma = new Activity_Contacts();
        viewsCount = MYViewPagerAdapter_Contacts.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Contacts.viewsCurrentItem + 1;

        if(Activity_Contacts.firstCircleNum != viewsCurrent){
            Activity_Contacts.firstCircleNum = viewsCurrent;
