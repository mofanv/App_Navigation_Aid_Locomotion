 ...
 */
public class Activity_Note extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_note_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "添加笔记");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "星级笔记");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "全部笔记");
        }
    }
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_note_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_note_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_note_3, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Note());
        ...
        MYViewPagerAdapter_Note adapter = new MYViewPagerAdapter_Note();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);

        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.note_dot);
...
class MYViewPagerAdapter_Note extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Note ma = new Activity_Note();
...
class CustmerAnimation_Note implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Note ma = new Activity_Note();
        viewsCount = MYViewPagerAdapter_Note.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Note.viewsCurrentItem + 1;

        if(Activity_Note.firstCircleNum != viewsCurrent){
            Activity_Note.firstCircleNum = viewsCurrent;
