 ...
 */
public class Activity_Stocks extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_stocks_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "股票 1");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "股票 2");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "股票 3");
        }else if(viewsCurrent == 4){
            new CustomToast_Text(mContext, "股票 4");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_stocks_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_stocks_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_stocks_3, null);
        View view4 = LayoutInflater.from(this).inflate(R.layout.acti_stocks_4, null);
        View view5 = LayoutInflater.from(this).inflate(R.layout.acti_stocks_5, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Stocks());
        ...
        MYViewPagerAdapter_Stocks adapter = new MYViewPagerAdapter_Stocks();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.stocks_dot);
...
class MYViewPagerAdapter_Stocks extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Stocks ma = new Activity_Stocks();
...
class CustmerAnimation_Stocks implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Stocks ma = new Activity_Stocks();
        viewsCount = MYViewPagerAdapter_Stocks.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Stocks.viewsCurrentItem + 1;

        if(Activity_Stocks.firstCircleNum != viewsCurrent){
            Activity_Stocks.firstCircleNum = viewsCurrent;
