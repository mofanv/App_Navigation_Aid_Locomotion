 ...
 */
public class Activity_Music extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_music_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "按偏好播放");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "播放列表");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_music_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_music_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_music_3, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Music());
        ...
        MYViewPagerAdapter_Music adapter = new MYViewPagerAdapter_Music();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.music_dot);
...
class MYViewPagerAdapter_Music extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Music ma = new Activity_Music();
...
class CustmerAnimation_Music implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Music ma = new Activity_Music();
        viewsCount = MYViewPagerAdapter_Music.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Music.viewsCurrentItem + 1;

        if(Activity_Music.firstCircleNum != viewsCurrent){
            Activity_Music.firstCircleNum = viewsCurrent;
