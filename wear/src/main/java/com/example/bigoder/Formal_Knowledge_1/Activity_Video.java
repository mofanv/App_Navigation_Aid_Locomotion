 ...
 */
public class Activity_Video extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_video_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "上次播放");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_video_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_video_2, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Video());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);
        views.add(view2);

        MYViewPagerAdapter_Video adapter = new MYViewPagerAdapter_Video();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.video_dot);
...
class MYViewPagerAdapter_Video extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Video ma = new Activity_Video();
...
class CustmerAnimation_Video implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Video ma = new Activity_Video();
        viewsCount = MYViewPagerAdapter_Video.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Video.viewsCurrentItem + 1;

        if(Activity_Video.firstCircleNum != viewsCurrent){
            Activity_Video.firstCircleNum = viewsCurrent;
