 ...
 */
public class Activity_Photos extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_photos_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "最近照片");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "全部照片");
        }else if(viewsCurrent == 3){
            new CustomToast_Text(mContext, "印象搜索");
        }
    }
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_photos_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_photos_2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.acti_photos_3, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Photos());
        ...
        MYViewPagerAdapter_Photos adapter = new MYViewPagerAdapter_Photos();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.photos_dot);
...
class MYViewPagerAdapter_Photos extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Photos ma = new Activity_Photos();
...
class CustmerAnimation_Photos implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Photos ma = new Activity_Photos();
        viewsCount = MYViewPagerAdapter_Photos.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Photos.viewsCurrentItem + 1;

        if(Activity_Photos.firstCircleNum != viewsCurrent){
            Activity_Photos.firstCircleNum = viewsCurrent;
