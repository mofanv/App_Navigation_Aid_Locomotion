 ...
 */
public class Activity_Chess extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_chess_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "继续游戏");
    ...
    public void setToast(int viewsCurrent) {
        ...
        if (viewsCurrent == 1) {
            ...
            new CustomToast_Text(mContext, "新游戏");
        }
    }
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_chess_1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.acti_chess_2, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Chess());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);
        views.add(view2);

        MYViewPagerAdapter_Chess adapter = new MYViewPagerAdapter_Chess();
        adapter.setViews(views);
        viewPager.setAdapter(adapter);
        firstCircleNum = viewPager.getCurrentItem() + 1;

        mNumLayout = (LinearLayout) findViewById(R.id.chess_dot);
...
class MYViewPagerAdapter_Chess extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Chess ma = new Activity_Chess();
...
class CustmerAnimation_Chess implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        Activity_Chess ma = new Activity_Chess();
        viewsCount = MYViewPagerAdapter_Chess.viewsCount;
        viewsCurrent = MYViewPagerAdapter_Chess.viewsCurrentItem + 1;

        if(Activity_Chess.firstCircleNum != viewsCurrent){
            Activity_Chess.firstCircleNum = viewsCurrent;
