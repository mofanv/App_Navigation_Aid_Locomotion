 ...
 */
public class Activity_Calculator extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_calculator_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "计算器");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_calculator_1, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Calculator());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);

        MYViewPagerAdapter_Calculator adapter = new MYViewPagerAdapter_Calculator();
...
class MYViewPagerAdapter_Calculator extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Calculator ma = new Activity_Calculator();
...
class CustmerAnimation_Calculator implements ViewPager.PageTransformer {
