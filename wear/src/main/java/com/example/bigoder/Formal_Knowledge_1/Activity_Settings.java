 ...
 */
public class Activity_Settings extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_settings_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "系统设置");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_settings_1, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Settings());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);

        MYViewPagerAdapter_Settings adapter = new MYViewPagerAdapter_Settings();
...
class MYViewPagerAdapter_Settings extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Settings ma = new Activity_Settings();
...
class CustmerAnimation_Settings implements ViewPager.PageTransformer {
