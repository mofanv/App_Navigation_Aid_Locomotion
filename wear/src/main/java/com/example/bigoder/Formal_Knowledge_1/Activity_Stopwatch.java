 ...
 */
public class Activity_Stopwatch extends Activity implements DataApi.DataListener,
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.acti_stopwatch_main);
        initViewPager();
        mContext = getApplicationContext();
        new CustomToast_Text(mContext, "秒表");
    ...
    private void initViewPager() {
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.acti_stopwatch_1, null);

        viewPager.setPageTransformer(true, new CustmerAnimation_Stopwatch());

        ArrayList<View> views = new ArrayList<View>();
        views.add(view1);

        MYViewPagerAdapter_Stopwatch adapter = new MYViewPagerAdapter_Stopwatch();
...
class MYViewPagerAdapter_Stopwatch extends PagerAdapter {
    ...
    public int getCount() {
        ...
        Activity_Stopwatch ma = new Activity_Stopwatch();
...
class CustmerAnimation_Stopwatch implements ViewPager.PageTransformer {
